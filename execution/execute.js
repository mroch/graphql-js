...
function executeImpl(args) {
  ...
  var context = void 0;
  try {
    context = buildExecutionContext(args.schema, args.document, args.rootValue, args.contextValue, args.variableValues, args.operationName, args.fieldResolver);
  } catch (error) {
  ...
  // resolved Promise.
  return Promise.resolve(executeOperation(context)).then(function (data) {
